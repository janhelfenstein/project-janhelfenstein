...
ggplot(data = survey_small, 
  ...
  labs(title = "number of days per year where authorities remove forest waste",
       x = "age in years", y = "suggested days of waste-removal")
```

The next bar plot @fig-visits shows the relation between the participants' forest-visiting frequency and their rating of the forest's cleanliness. Generally, people who visit the forest more often tend to give a higher rating.
