...
Note: The last two datapoints (one male and one female participant on June 5th, on the veryright of the diagram) were manually entered by the study author to include the
...
```{r}
#| label: age-gender-removalfrequency
