...
The following tables provide a statistical summary of the numerical values collected from the survey.

The first table @tbl_statistics1 lists the average and median ages of the participants, grouped by gender. The average age is close to the median age, around 33 to 34. However, the standard deviation is quite large, so there are outliers: Some participants were much older than others. The maximum age was 63, as shown above in @fig_demography .
...
#|tbl-cap: -cap: "Statistical data of the survey, part 1"
